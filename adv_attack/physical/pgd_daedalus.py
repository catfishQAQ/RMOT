...
class PhyPGDAttackerDaedalus:
    def __init__(
        ...
        if self.attack_type == "phy_daedalus":
            self.loss_weights = loss_weights
        else:
            raise ValueError(f"Unknown mode: {attack_type}. Supported modes: 'phy_daedalus'.")
